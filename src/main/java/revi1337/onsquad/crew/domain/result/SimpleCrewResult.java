...
public record SimpleCrewResult(
    ...
    @QueryProjection
    public SimpleCrewResult(Long id, Name name, Introduce introduce, String kakaoLink, String imageUrl,
                            SimpleMemberDomainDto owner) {
        this.id = id;
        this.name = name;
    ...
    @QueryProjection
    public SimpleCrewResult(Long id, Name name, String kakaoLink, String imageUrl,
                            SimpleMemberDomainDto owner) {
