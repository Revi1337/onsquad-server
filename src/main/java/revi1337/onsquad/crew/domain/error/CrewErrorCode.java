package revi1337.onsquad.crew.domain.error;
...
public enum CrewErrorCode implements ErrorCode {
    ...
    ALREADY_EXISTS(400, "CR005", "크루가 이미 존재하여 크루를 개설할 수 없습니다."),
    NOT_FOUND(404, "CR006", "크루를 찾을 수 없습니다."),
    MISMATCH_CREW_REFERENCE(400, "CR007", "참가자가 속한 크루가 일치하지 않습니다."),
    ...
    INSUFFICIENT_READ_PARTICIPANTS_AUTHORITY(403, "CR012", "크루 참가자 조회는 크루장만 가능합니다."),
    INSUFFICIENT_MANAGE_CREW_AUTHORITY(403, "CR013", "크루 관리는 크루 매니저 이상만 가능합니다."),
    INSUFFICIENT_LEAVE_CREW_AUTHORITY(403, "CR014", "크루장은 권한 위임 후 탈퇴 가능합니다.");
