...
public record SquadMemberResult(
    ...
    @QueryProjection
    public SquadMemberResult(Boolean isMe, LocalDateTime participantAt, SimpleMemberResult member) {
        this.isMe = isMe;
    ...
    @QueryProjection
    public SquadMemberResult(LocalDateTime participantAt, SimpleMemberResult member) {
