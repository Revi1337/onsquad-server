...
public record SquadWithMemberDomainDto(
    ...
    @QueryProjection
    public SquadWithMemberDomainDto(Long id, Title title, Capacity capacity, Address address, String kakaoLink,
                                    String discordLink, Boolean isOwner, Set<CategoryType> categories,
                                    List<SquadMemberDomainDto> members) {
        this.id = id;
        this.title = title;
