...
//
//    @Builder
//    private SquadComment(Long id, String content, Crew crew, Member member, SquadComment parent) {
//        this.id = id;
//        this.content = content;
//        this.crew = crew;
//        this.member = member;
...
//    }
//
//    public static SquadComment forSquad(String content, Crew crew, Member member) {
