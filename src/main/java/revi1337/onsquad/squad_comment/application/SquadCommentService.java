...
//import revi1337.onsquad.squad_comment.dto.CreateSquadCommentDto;
//
...
//    private final SquadCommentJpaRepository commentRepository;
//
//    /**
...
//     */
//    @Transactional
//    public SquadCommentDto addComment(String crewName, Long squadId, CreateSquadCommentDto dto, Long memberId) {
...
//    }
//
//    private SquadCommentDto persistSquadCommentIfValid(String crewName, CreateSquadCommentDto dto, Long memberId, Squad squad) {
...
//    }
//
//    private SquadCommentDto persistCommentIfMemberExists(CreateSquadCommentDto dto, Long memberId, Squad squad) {
...
//    }
//
//    private SquadCommentDto persistCommentAndConvertDto(CreateSquadCommentDto dto, Squad squad, Member member) {
//        SquadComment comment = SquadComment.forSquad(dto.content(), squad.getCrew(), member);
//        commentRepository.save(comment);
//        return SquadCommentDto.from(comment, member);
//    }
//}
