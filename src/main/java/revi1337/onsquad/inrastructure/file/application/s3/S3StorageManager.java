...
import revi1337.onsquad.inrastructure.file.application.FilenameConvertStrategy;
import revi1337.onsquad.inrastructure.file.error.FileErrorCode;
import revi1337.onsquad.inrastructure.file.error.exception.FileActionException;
import revi1337.onsquad.inrastructure.file.error.exception.FileControlException;
...
public class S3StorageManager implements FileStorageManager {
    ...
    public String upload(byte[] fileContent, String fileName) {
        try (InputStream inputStream = new ByteArrayInputStream(fileContent)) {
            ...
            throw new FileControlException.FailProcess(FileErrorCode.FAIL_PROCESS, exception);
        }
    }
