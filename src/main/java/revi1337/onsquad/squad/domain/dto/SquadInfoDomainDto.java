...
public record SquadInfoDomainDto(
    ...
    @QueryProjection
    public SquadInfoDomainDto(Long id, Title title, Content content, Capacity capacity, Address address, String kakaoLink, String discordLink, List<CategoryType> categories, SimpleMemberInfoDomainDto squadOwner) {
        this.id = id;
        this.title = title;
