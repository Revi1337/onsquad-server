...
import revi1337.onsquad.auth.application.oauth2.GoogleOAuth2AccessTokenEvaluator;
import revi1337.onsquad.auth.application.oauth2.GoogleOAuth2EndpointBuilder;
import revi1337.onsquad.auth.application.oauth2.GoogleOAuth2UserProfileEvaluator;
import revi1337.onsquad.auth.application.oauth2.KakaoOAuth2AccessTokenEvaluator;
import revi1337.onsquad.auth.application.oauth2.KakaoOAuth2EndpointBuilder;
import revi1337.onsquad.auth.application.oauth2.KakaoOAuth2UserProfileEvaluator;
import revi1337.onsquad.auth.application.oauth2.PlatformOAuth2AccessTokenEvaluator;
import revi1337.onsquad.auth.application.oauth2.PlatformOAuth2EndpointBuilder;
import revi1337.onsquad.auth.application.oauth2.PlatformOAuth2UserProfileEvaluator;
...
public enum SupportOAuth2Platform implements AuthorizationEndPointProvider,
    ...
    KAKAO {
        ...
        public URI provideUsing(String baseUrl, OAuth2ClientProperties oAuth2ClientProperties) {
            ...
            PlatformOAuth2EndpointBuilder endpointBuilder = new KakaoOAuth2EndpointBuilder();
        ...
        public AccessToken provideAccessToken(String baseUrl, String authorizationCode,
            ...
            OAuth2Properties oAuth2Properties = getPropertyFrom(oAuth2ClientProperties);
            PlatformOAuth2AccessTokenEvaluator accessTokenEvaluator = new KakaoOAuth2AccessTokenEvaluator();
            return accessTokenEvaluator.provideAccessToken(baseUrl, authorizationCode, oAuth2Properties);
        }
        ...
        public PlatformUserProfile provideUserProfile(AccessToken accessToken,
                                                      OAuth2ClientProperties oAuth2ClientProperties) {
            OAuth2Properties oAuth2Properties = getPropertyFrom(oAuth2ClientProperties);
            PlatformOAuth2UserProfileEvaluator userProfileEvaluator = new KakaoOAuth2UserProfileEvaluator();
    ...
    GOOGLE {
        ...
        public URI provideUsing(String baseUrl, OAuth2ClientProperties oAuth2ClientProperties) {
            OAuth2Properties oAuth2Properties = getPropertyFrom(oAuth2ClientProperties);
            PlatformOAuth2EndpointBuilder endpointBuilder = new GoogleOAuth2EndpointBuilder();
            return endpointBuilder.provideUsing(baseUrl, oAuth2Properties);
        }
        ...
        public AccessToken provideAccessToken(String baseUrl, String authorizationCode,
                                              OAuth2ClientProperties oAuth2ClientProperties) {
            OAuth2Properties oAuth2Properties = getPropertyFrom(oAuth2ClientProperties);
            PlatformOAuth2AccessTokenEvaluator accessTokenEvaluator = new GoogleOAuth2AccessTokenEvaluator();
            return accessTokenEvaluator.provideAccessToken(baseUrl, authorizationCode, oAuth2Properties);
        }
        ...
        public PlatformUserProfile provideUserProfile(AccessToken accessToken,
                                                      OAuth2ClientProperties oAuth2ClientProperties) {
            OAuth2Properties oAuth2Properties = getPropertyFrom(oAuth2ClientProperties);
            PlatformOAuth2UserProfileEvaluator userProfileEvaluator = new GoogleOAuth2UserProfileEvaluator();
            return userProfileEvaluator.provideUserProfile(accessToken, oAuth2Properties);
        }
    };
