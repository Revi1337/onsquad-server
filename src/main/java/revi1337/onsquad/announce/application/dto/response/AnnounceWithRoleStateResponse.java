...
public record AnnounceWithRoleStateResponse(
    ...
    public static AnnounceWithRoleStateResponse from(CrewRole role, AnnounceDetail detail) {
        return new AnnounceWithRoleStateResponse(
