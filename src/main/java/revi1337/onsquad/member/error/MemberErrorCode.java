...
public enum MemberErrorCode implements ErrorCode {
    ...
    INVALID_INTRODUCE_LENGTH(400, "M005", "나의 소개는 %d 자 이상 %d 자 이하여야 합니다."),

    NOTFOUND(404, "M006", "id 가 %d 인 사용자를 찾을 수 없습니다."),
    WRONG_PASSWORD(400, "M007", "id 가 %d 인 사용자의 비밀번호가 일치하지 않습니다.");
