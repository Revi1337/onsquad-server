...
class IterativeTwoLevelCommentSanitizerTest {

    private final CommentCombinator commentCombinator = new CommentCombinator();
    private final CommentSanitizer commentSanitizer = new CommentSanitizer(new IterativeTwoLevelCommentSanitizer(new DefaultCommentMaskPolicy()));
