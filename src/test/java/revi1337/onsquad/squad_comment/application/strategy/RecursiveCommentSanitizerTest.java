...
class RecursiveCommentSanitizerTest {

    private final CommentCombinator commentCombinator = new CommentCombinator();
    private final CommentSanitizer commentSanitizer = new CommentSanitizer(new RecursiveCommentSanitizer(new DefaultCommentMaskPolicy()));
