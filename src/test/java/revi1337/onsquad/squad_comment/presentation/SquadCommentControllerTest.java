            ...
            when(squadCommentQueryService.fetchInitialComments(eq(MEMBER_ID), eq(CREW_ID), eq(SQUAD_ID), any(PageRequest.class), eq(CHILD_SIZE)))
                    .thenReturn(List.of(
                            new SquadCommentResponse(null,
                                    ...
                                    LocalDateTime.now(),
                                    LocalDateTime.now(),
                                    new SimpleMemberResponse(1L, REVI_EMAIL_VALUE, REVI_NICKNAME_VALUE, REVI_INTRODUCE_VALUE, REVI_MBTI_VALUE),
                                    List.of(
                                            new SquadCommentResponse(
                                                    ...
                                                    LocalDateTime.now(),
                                                    LocalDateTime.now(),
                                                    new SimpleMemberResponse(2L, ANDONG_EMAIL_VALUE, ANDONG_NICKNAME_VALUE, ANDONG_INTRODUCE_VALUE,
                                                            ANDONG_MBTI_VALUE),
                                                    List.of()
                                            ),
                                            new SquadCommentResponse(
                            ...
                            new SquadCommentResponse(
                                    ...
                                    LocalDateTime.now(),
                                    LocalDateTime.now(),
                                    new SimpleMemberResponse(3L, KWANGWON_EMAIL_VALUE, KWANGWON_NICKNAME_VALUE, KWANGWON_INTRODUCE_VALUE, KWANGWON_MBTI_VALUE),
                                    List.of(
                                            new SquadCommentResponse(
                                                    4L,
                                                    5L,
            ...
            when(squadCommentQueryService.fetchMoreChildren(eq(MEMBER_ID), eq(CREW_ID), eq(SQUAD_ID), eq(PARENT_ID), any(PageRequest.class)))
                    .thenReturn(List.of(
                            new SquadCommentResponse(
                                    ...
                                    LocalDateTime.now(),
                                    LocalDateTime.now(),
                                    new SimpleMemberResponse(2L, ANDONG_EMAIL_VALUE, ANDONG_NICKNAME_VALUE, ANDONG_INTRODUCE_VALUE, ANDONG_MBTI_VALUE),
                                    List.of()
                            ),
                            new SquadCommentResponse(
                                    PARENT_ID,
