...
@ContextConfiguration(classes = {VerificationCodeReloader.class, CaffeineVerificationCodeStorage.class, ObjectMapperConfig.class})
...
class VerificationCodeReloaderTest {
    ...
    void setUp() {
        Cache<String, TimedEntry<VerificationCode>> verificationStore =
                (Cache<String, TimedEntry<VerificationCode>>) ReflectionTestUtils.getField(caffeineVerificationCodeStorage, "verificationStore");
    ...
    void restore(@TempDir Path tempDir) throws IOException {
        ...
        caffeineVerificationCodeStorage.saveVerificationCode("test@email.com1", "1234", VerificationStatus.PENDING, Duration.ofMinutes(4));
        caffeineVerificationCodeStorage.saveVerificationCode("test@email.com2", "1234", VerificationStatus.SUCCESS, Duration.ofMinutes(4));
        caffeineVerificationCodeStorage.saveVerificationCode("test@email.com3", "1234", VerificationStatus.PENDING, Duration.ofMinutes(4));
        VerificationCodes verificationCodes = caffeineVerificationCodeStorage.getVerificationCodes();
        ...
        VerificationCodes restoredVerificationCodes = caffeineVerificationCodeStorage.getVerificationCodes();
        assertSoftly(softly -> {
    ...
    void backup(@TempDir Path tempDir) throws IOException {
        ...
        caffeineVerificationCodeStorage.saveVerificationCode("test@email.com2", "1234", VerificationStatus.SUCCESS, Duration.ofMinutes(4));
        caffeineVerificationCodeStorage.saveVerificationCode("test@email.com3", "1234", VerificationStatus.PENDING, Duration.ofMinutes(4));
        caffeineVerificationCodeStorage.saveVerificationCode("test@email.com4", "1234", VerificationStatus.PENDING, Duration.ofMinutes(4));
