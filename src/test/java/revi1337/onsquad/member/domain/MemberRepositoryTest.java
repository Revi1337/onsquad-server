...
class MemberRepositoryTest extends PersistenceLayerTestSupport {
    ...
    public void findMemberWithCrewMembers() {
        ...
        Crew crew1 = CrewFactory.defaultCrew().image(ImageFactory.defaultImage()).name(new Name("크루 1")).member(member1)
                .build();
        Crew crew2 = CrewFactory.defaultCrew().image(ImageFactory.defaultImage()).name(new Name("크루 2")).member(member2)
                .build();
        Crew crew3 = CrewFactory.defaultCrew().image(ImageFactory.defaultImage()).name(new Name("크루 3")).member(member1)
                .build();
        ...
        crewMemberRepository.saveAll(
                List.of(crewMember1, crewMember2, crewMember3, crewMember4, crewMember5, crewMember6, crewMember7,
                        crewMember8));
