...
public class ValueFixture {
    ...
    public static final String REVI_USER_TYPE = UserType.GENERAL.getText();
    public static final String ANDONG_USER_TYPE = UserType.GENERAL.getText();
    public static final String KWANGWON_USER_TYPE = UserType.GENERAL.getText();
