...
class CrewQueryDslRepositoryTest extends PersistenceLayerTestSupport {
    ...
    public void findAllByMemberId() {
        ...
        crewJpaRepository.saveAll(List.of(crew1, crew2, crew3, crew4, crew5));

        // when
        List<EnrolledCrewDomainDto> ownedCrews = crewQueryDslRepository.findOwnedCrews(member2.getId());
    ...
    public void findCrewsByName() {
        ...
        // when
        List<CrewWithMemberAndImageDto> crewWithMemberAndImageDtoList = crewQueryDslRepository.findCrewsByName();
