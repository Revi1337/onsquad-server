...
import revi1337.onsquad.token.infrastructure.application.ExpiringMapRefreshTokenManager;
...
class JsonWebTokenManagerTest {
    ...
    class ExpiringMapJsonWebTokenManagerTest extends ApplicationLayerTestSupport {
        ...
        private ExpiringMapJsonWebTokenManagerTest(
                ...
                JsonWebTokenProvider jsonWebTokenProvider,
                ExpiringMapRefreshTokenManager expiringMapRefreshTokenManager
        ) {
            this.expiringMapTokenRepository = expiringMapTokenRepository;
            this.jsonWebTokenManager = new JsonWebTokenManager(jsonWebTokenProvider, expiringMapRefreshTokenManager);
        }
